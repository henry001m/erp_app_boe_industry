...
class S {
  ...
  String get nameVendor {
   ...
   /// `Vendor description`
  String get descriptionVendor {
    return Intl.message(
      'Vendor Description',
      name: 'vedorDesription',
      desc: '',
      args: [],
    );
  }
  ...
  String get selectWeChatQr {
    ...
    /// `Vendor background`
  String get vendorBackground {
    return Intl.message(
      'Select Vendor Background',
      name: 'vendorBackground',
      desc: '',
      args: [],
    );
  }
    ...
    /// `Vendor Video`
  String get selectVendorVideo {
    return Intl.message(
      'Select Vendor Video',
      name: 'selectVendorVideo',
      desc: '',
      args: [],
    );
  }
  ...
  /// `The first name field is required`
  String get proveedorIsRequired {
    return Intl.message(
      'El nombre del proveedor es requerido',
      name: 'proveedorIsRequired',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Adding your video`
  String get addingYourVideo {
    return Intl.message(
      'Adding your video',
      name: 'addingYourVideo',
      desc: '',
      args: [],
    );
  }
  ...
  String get waitForLoad {
   ...
   /// `Waiting for loading image`
  String get waitForLoadVideo {
    return Intl.message(
      'Waiting for loading video',
      name: 'waitForLoadVideo',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Waiting for posting vendor`
  String get waitForPostVendor {
    return Intl.message(
      'Waiting for posting vendor',
      name: 'waitForPostVendor',
      desc: '',
      args: [],
    );
  }

  /// `Waiting for posting trademark`
  String get waitForPostTradeMark {
    return Intl.message(
      'Waiting for posting trademark',
      name: 'waitForPostTradeMark',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Are you sure you wish to delete this mark?`
  String get confirmDeleteTradeMark {
    return Intl.message(
      'Are you sure you wish to delete this trademark?',
      name: 'confirmDeleteTradeMark',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Your relation will show up after review.`
  String get relationTradeMarkVedorReview {
    return Intl.message(
      'Your realtin will show up after review.',
      name: 'relationTradeMarkVedorReview',
      desc: '',
      args: [],
    );
  }

  /// `Your trademark will show up after review.`
  String get tradeMarkCreateReview {
    return Intl.message(
      'Your trademark will show up after review.',
      name: 'tradeMarkCreateReview',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Choose trademark`
  String get chooseTrademark {
    return Intl.message(
      'Choose Trademark',
      name: 'chooseTrademark',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Please enter the trademark name`
  String get pleaseEnterTradeMarkName {
    return Intl.message(
      'Please enter the trademark name',
      name: 'pleaseEntertradeMarkName',
      desc: '',
      args: [],
    );
  }
  ...
  String get createCategoryConfirmationMsg {
    return Intl.message(
      'Are you sure to create the category?',
      name: 'createCategoryConfirmationMsg',
      desc: '',
      args: [],
    );
  }
